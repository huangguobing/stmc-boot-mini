package cn.iocoder.stmc.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import cn.iocoder.stmc.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.iocoder.stmc.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "stmc源码，牛逼！")
    @ExcelProperty("结果提示")
