package cn.iocoder.stmc.module.system.controller.admin.sms.vo.template;
...
import cn.iocoder.stmc.module.system.enums.DictTypeConstants;
...
public class SmsTemplateRespVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "stmc")
    @ExcelProperty("模板名称")
    private String name;
