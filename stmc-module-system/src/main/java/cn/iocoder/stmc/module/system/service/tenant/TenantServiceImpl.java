package cn.iocoder.stmc.module.system.service.tenant;
...
import cn.iocoder.stmc.framework.tenant.config.TenantProperties;
import cn.iocoder.stmc.framework.tenant.core.context.TenantContextHolder;
import cn.iocoder.stmc.framework.tenant.core.util.TenantUtils;
import cn.iocoder.stmc.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import cn.iocoder.stmc.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.iocoder.stmc.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.iocoder.stmc.module.system.convert.tenant.TenantConvert;
...
import cn.iocoder.stmc.module.system.dal.dataobject.tenant.TenantDO;
import cn.iocoder.stmc.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.iocoder.stmc.module.system.dal.mysql.tenant.TenantMapper;
import cn.iocoder.stmc.module.system.enums.permission.RoleCodeEnum;
import cn.iocoder.stmc.module.system.enums.permission.RoleTypeEnum;
...
import cn.iocoder.stmc.module.system.service.tenant.handler.TenantInfoHandler;
import cn.iocoder.stmc.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 stmc.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
