package cn.iocoder.stmc.module.system.controller.admin.socail.vo.client;
...
import cn.iocoder.stmc.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "stmc商城")
