package cn.iocoder.stmc.framework.tenant.config;

import cn.iocoder.stmc.framework.common.biz.system.tenant.TenantCommonApi;
import cn.iocoder.stmc.framework.common.enums.WebFilterOrderEnum;
import cn.iocoder.stmc.framework.mybatis.core.util.MyBatisUtils;
import cn.iocoder.stmc.framework.redis.config.StmcCacheProperties;
import cn.iocoder.stmc.framework.security.core.service.SecurityFrameworkService;
import cn.iocoder.stmc.framework.tenant.core.aop.TenantIgnore;
import cn.iocoder.stmc.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.iocoder.stmc.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.iocoder.stmc.framework.tenant.core.job.TenantJobAspect;
import cn.iocoder.stmc.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.iocoder.stmc.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.iocoder.stmc.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.iocoder.stmc.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.iocoder.stmc.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.iocoder.stmc.framework.tenant.core.service.TenantFrameworkService;
import cn.iocoder.stmc.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.iocoder.stmc.framework.tenant.core.web.TenantContextWebFilter;
import cn.iocoder.stmc.framework.tenant.core.web.TenantVisitContextInterceptor;
