package cn.iocoder.stmc.framework.websocket.config;

import cn.iocoder.stmc.framework.mq.redis.config.StmcRedisMQConsumerAutoConfiguration;
import cn.iocoder.stmc.framework.mq.redis.core.RedisMQTemplate;
import cn.iocoder.stmc.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import cn.iocoder.stmc.framework.websocket.core.listener.WebSocketMessageListener;
import cn.iocoder.stmc.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import cn.iocoder.stmc.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import cn.iocoder.stmc.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import cn.iocoder.stmc.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import cn.iocoder.stmc.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import cn.iocoder.stmc.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import cn.iocoder.stmc.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import cn.iocoder.stmc.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import cn.iocoder.stmc.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import cn.iocoder.stmc.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import cn.iocoder.stmc.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import cn.iocoder.stmc.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import cn.iocoder.stmc.framework.websocket.core.session.WebSocketSessionManager;
import cn.iocoder.stmc.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
public class StmcWebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "stmc.websocket", name = "sender-type", havingValue = "local")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "stmc.websocket", name = "sender-type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "stmc.websocket", name = "sender-type", havingValue = "rocketmq")
    public class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${stmc.websocket.sender-rocketmq.topic}") String topic) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "stmc.websocket", name = "sender-type", havingValue = "rabbitmq")
    public class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${stmc.websocket.sender-rabbitmq.exchange}") String exchange) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "stmc.websocket", name = "sender-type", havingValue = "kafka")
    public class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${stmc.websocket.sender-kafka.topic}") String topic) {
