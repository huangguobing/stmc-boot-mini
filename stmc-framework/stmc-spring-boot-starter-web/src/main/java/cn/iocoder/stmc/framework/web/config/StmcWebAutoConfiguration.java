package cn.iocoder.stmc.framework.web.config;
...
import cn.iocoder.stmc.framework.web.core.filter.CacheRequestBodyFilter;
import cn.iocoder.stmc.framework.web.core.filter.DemoFilter;
import cn.iocoder.stmc.framework.web.core.handler.GlobalExceptionHandler;
import cn.iocoder.stmc.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class StmcWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "stmc.demo", havingValue = "true")
