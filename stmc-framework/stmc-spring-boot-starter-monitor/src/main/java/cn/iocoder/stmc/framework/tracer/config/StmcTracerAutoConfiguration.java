package cn.iocoder.stmc.framework.tracer.config;

import cn.iocoder.stmc.framework.common.enums.WebFilterOrderEnum;
import cn.iocoder.stmc.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "stmc.tracer", value = "enable", matchIfMissing = true)
public class StmcTracerAutoConfiguration {
