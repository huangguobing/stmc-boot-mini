...
(5135, '订单状态更新', 'erp:order:update-status', 3, 5, 5130, '', '', '', '', 0, b'1', b'1', b'1', 'admin', NOW(), 'admin', NOW(), b'0');
...
(5143, '付款修改', 'erp:payment:update', 3, 3, 5140, '', '', '', '', 0, b'1', b'1', b'1', 'admin', NOW(), 'admin', NOW(), b'0'),
(5144, '付款审批', 'erp:payment:approve', 3, 4, 5140, '', '', '', '', 0, b'1', b'1', b'1', 'admin', NOW(), 'admin', NOW(), b'0'),
(5145, '付款删除', 'erp:payment:delete', 3, 5, 5140, '', '', '', '', 0, b'1', b'1', b'1', 'admin', NOW(), 'admin', NOW(), b'0');
...
-- 示例客户数据
INSERT INTO `erp_customer` (`name`, `code`, `contact`, `mobile`, `email`, `address`, `bank_name`, `bank_account`, `tax_no`, `credit_limit`, `status`, `sort`, `remark`, `creator`, `tenant_id`) VALUES
('北京科技有限公司', 'C001', '张三', '13800138001', 'zhangsan@example.com', '北京市朝阳区XX路XX号', '中国银行北京分行', '6222021234567890123', '91110105MA12345678', 100000.00, 0, 1, '重点客户', 'admin', 0),
('上海贸易有限公司', 'C002', '李四', '13800138002', 'lisi@example.com', '上海市浦东新区XX路XX号', '工商银行上海分行', '6222021234567890124', '91310115MA23456789', 50000.00, 0, 2, '普通客户', 'admin', 0),
('广州电子有限公司', 'C003', '王五', '13800138003', 'wangwu@example.com', '广州市天河区XX路XX号', '建设银行广州分行', '6222021234567890125', '91440106MA34567890', 80000.00, 0, 3, '', 'admin', 0);

-- 示例供应商数据
INSERT INTO `erp_supplier` (`name`, `code`, `contact`, `mobile`, `email`, `address`, `bank_name`, `bank_account`, `tax_no`, `payment_days`, `status`, `sort`, `remark`, `creator`, `tenant_id`) VALUES
('深圳原材料供应商', 'S001', '赵六', '13900139001', 'zhaoliu@example.com', '深圳市南山区XX路XX号', '招商银行深圳分行', '6222031234567890123', '91440300MA45678901', 30, 0, 1, '主要供应商', 'admin', 0),
('东莞配件供应商', 'S002', '钱七', '13900139002', 'qianqi@example.com', '东莞市长安镇XX路XX号', '农业银行东莞分行', '6222031234567890124', '91441900MA56789012', 45, 0, 2, '', 'admin', 0),
('佛山包装供应商', 'S003', '孙八', '13900139003', 'sunba@example.com', '佛山市禅城区XX路XX号', '中信银行佛山分行', '6222031234567890125', '91440600MA67890123', 15, 0, 3, '', 'admin', 0);

-- 示例订单数据
INSERT INTO `erp_order` (`order_no`, `customer_id`, `supplier_id`, `order_type`, `status`, `order_date`, `delivery_date`, `total_quantity`, `total_amount`, `discount_amount`, `payable_amount`, `paid_amount`, `contact`, `mobile`, `address`, `remark`, `creator`, `tenant_id`) VALUES
('SO202512290001', 1, NULL, 1, 20, '2025-12-29 10:00:00', '2025-12-31 10:00:00', 100.00, 50000.00, 1000.00, 49000.00, 20000.00, '张三', '13800138001', '北京市朝阳区XX路XX号', '销售订单-已确认', 'admin', 0),
('SO202512290002', 2, NULL, 1, 0, '2025-12-29 11:00:00', '2026-01-05 10:00:00', 50.00, 25000.00, 500.00, 24500.00, 0.00, '李四', '13800138002', '上海市浦东新区XX路XX号', '销售订单-草稿', 'admin', 0),
('PO202512290001', NULL, 1, 2, 30, '2025-12-29 09:00:00', '2025-12-30 09:00:00', 200.00, 30000.00, 0.00, 30000.00, 15000.00, '赵六', '13900139001', '深圳市南山区XX路XX号', '采购订单-处理中', 'admin', 0),
('PO202512290002', NULL, 2, 2, 10, '2025-12-29 14:00:00', '2026-01-02 09:00:00', 150.00, 20000.00, 200.00, 19800.00, 0.00, '钱七', '13900139002', '东莞市长安镇XX路XX号', '采购订单-待确认', 'admin', 0);

-- 示例付款数据
INSERT INTO `erp_payment` (`payment_no`, `supplier_id`, `order_id`, `payment_type`, `status`, `amount`, `payment_method`, `payment_account`, `payment_date`, `remark`, `creator`, `tenant_id`) VALUES
('PAY202512290001', 1, 3, 1, 20, 15000.00, 1, '公司基本户', '2025-12-29 15:00:00', '采购订单PO202512290001首付款', 'admin', 0),
('PAY202512290002', 2, NULL, 2, 0, 5000.00, 2, '备用金', NULL, '费用付款-待审批', 'admin', 0);

-- =============================================
-- 执行完成提示
-- =============================================
-- 执行完成后，请检查：
-- 1. 所有表是否创建成功：erp_customer, erp_supplier, erp_order, erp_payment
-- 2. 菜单是否正确显示：ERP管理 -> 客户管理/供应商管理/订单管理/付款管理
-- 3. 权限是否分配：给角色分配 erp:* 相关权限
